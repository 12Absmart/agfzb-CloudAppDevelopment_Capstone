...
urlpatterns = [
    ...
    path('dealers/<int:dealer_id>/', view=views.get_dealer_details, name='dealer_details'),

    # path for add a review view
    path('dealers/<int:dealer_id>/add_review/', view=views.add_review, name='add_review'),
